<template>
    <div class=" bg-white p-6 rounded-lg mx-[150px] flex flex-col text-black min-h-screen px-4 lg:px-[150px] py-8 space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="form-group flex flex-col">
          ...
          <input type="date" id="dateMatch" v-model="dateMatch" class="px-3 py-2 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500;" />
        </div>

        <div class="form-group flex flex-col">
          <label for="lieuMatch" class="mb-1 font-semibold">Lieu du match :</label>
          <input type="text" id="lieuMatch" v-model="lieuMatch" placeholder="Ex : Stade municipal" class="px-3 py-2 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500;" />
        </div>

        <div class="form-group flex flex-col">
          <label for="scoreA" class="mb-1 font-semibold">Score Équipe A :</label>
          <input type="number" id="scoreA" v-model.number="scoreEquipeA" min="0" class="px-3 py-2 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500;" />
        </div>

        <div class="form-group flex flex-col">
          <label for="scoreB" class="mb-1 font-semibold">Score Équipe B :</label>
          <input type="number" id="scoreB" v-model.number="scoreEquipeB" min="0" class="px-3 py-2 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500;" />
        </div>
      </div>
